...
<script type="text/javascript" src="resources/js/emailDatatables.js" defer></script>
<jsp:include page="fragments/bodyHeader.jsp"/>

<div class="jumbotron pt-4" style="margin: 0">
    <div class="container">
        <h2 style="margin-left: 15px"><spring:message code="email.title"/></h2>
        <br/>
        <table class="table table-striped" id="datatable">
            <thead>
            <tr>
                <th style="width: 110px"><spring:message code="email.registered"/></th>
                <th><spring:message code="email.sender"/></th>
                <th><spring:message code="email.subject"/></th>
                <th><spring:message code="email.message"/></th>
                <th></th>
            </tr>
            </thead>
        </table>

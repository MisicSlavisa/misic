            ...
            <div class="col-lg-5 col-md-6 home-about-right">
                <div style="width: auto">
                    <table style="height: content-box">
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>JavaScript</strong> 70% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>Spring MVC</strong> 90% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>Spring Data JPA </strong> 92% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>Spring Security</strong> 80% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>Hibernate ORM</strong> 78% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
            ...
            <div class="col-lg-5 col-md-6 home-about-right">
                <div style="width: auto">
                    <table style="height: content-box">
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>PostgreSQL </strong> 90% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                                <div class="skill" data-width="90">></div>
                            </td>
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>MS Access </strong> 80% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                                <div class="skill" data-width="80"></div>
                            </td>
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>MS SQL Server </strong> 60% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
            ...
            <div class="col-lg-5 col-md-6 home-about-right">
                <div style="width: auto">
                    <table style="height: content-box">
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>Photoshop</strong> 95% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>Illustrator</strong> 85% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                                <div class="skill" data-width="85"></div>
                            </td>
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>After Effects</strong> 60% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                                <div class="skill" data-width="60"></div>
                            </td>
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>Premier Pro</strong> 60% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                                <div class="skill" data-width="60"></div>
                            </td>
                        ...
                        <tr>
                            <td class="single-skill-short">
                                <p><strong>Acrobat Pro</strong> 75% </p>
                            </td>
                            <td style="width: 160px; padding-left: 20px">
                                <div class="skill" data-width="75"></div>
                            </td>

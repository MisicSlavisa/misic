...
<%@ taglib prefix="misic" tagdir="/WEB-INF/tags" %>
        ...
        <div class="row">
            <div class="col-5 offset-3">
                ...
                <form:form modelAttribute="userTo" class="form-horizontal" method="post" action="${register ? 'register' : 'profile'}"
                    ...
                    <misic:inputField labelCode="user.name" name="name"/>
                    <misic:inputField labelCode="user.email" name="email"/>
                    <misic:inputField labelCode="user.password" name="password" inputType="password"/>
